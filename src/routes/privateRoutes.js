import PostWritePage from '../pages/write/PostWritePage';
import RentWritePage from '../pages/write/RentWritePage';
import SellWritePage from '../pages/write/SellWritePage';

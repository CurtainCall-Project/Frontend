...
const DescriptonBox = (props) => {
  switch (props.boardType) {
    case 'free':
      return (
        <Box>
          <Text margin_bottom="5px">자유게시판</Text>
    ...
    case 'sight':
      return (
        <Box>
          <Text margin_bottom="5px">시야게시판</Text>
          <Text font_weight="regular" margin_bottom="5px">
    ...
    case 'new':
      return (
        <Box>
          <Text margin_bottom="5px">새내기게시판</Text>
          <Text font_weight="regular" margin_bottom="5px" line_height="20px">
    ...
    case 'rent':
      return (
        <Box>
          <Text margin_bottom="5px">오페라글라스 대여</Text>
          <Text font_weight="regular" margin_bottom="5px">
    ...
    case 'sell':
      return (
        <Box>
          <Text margin_bottom="5px">중고거래</Text>
          <Text font_weight="regular" margin_bottom="5px">
